...
- Device registration: connect to the trusted LAN API, call `POST /devices/register`, and store the returned device id securely.
- Child selection: fetch child profiles without credentials and bind one child profile to the device.
