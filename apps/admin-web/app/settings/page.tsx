    ...
    <Shell>
      ...
      <div className="grid gap-4">
        <Panel>
          ...
          <p className="mt-2 text-sm text-muted">OpenAPI docs are served by the HappiE backend at /docs and /openapi.json.</p>
        </Panel>

        <Panel>
          <h2 className="mb-2 font-semibold">Signed storage</h2>
          <p className="text-sm text-muted">The admin app never connects to Postgres, R2, or MinIO directly. Uploads and playback URLs are mediated by the HappiE API.</p>
        </Panel>
